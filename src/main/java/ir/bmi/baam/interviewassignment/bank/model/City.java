...
import ir.bmi.baam.interviewassignment.bank.utils.Haversine;
...
public class City implements Serializable {
    ...
    public double distanceToMe(Bank Bank) {
        return Haversine.distance(cityCentreLatitude, cityCentreLongitude, Bank.getLatitude(), Bank.getLatitude());
    }
